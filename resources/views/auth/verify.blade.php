                            ...
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                <div>
                                    <a href="index" class="d-inline-block auth-logo">
                                        <img src="{{ URL::asset('backend/assets/images/logo-light.png') }}" alt="" height="20">
                                    </a>
                                </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('backend/assets/libs/particles.js/particles.js.min.js') }}"></script>
    <script src="{{ URL::asset('backend/assets/js/pages/particles.app.js') }}"></script>
    <script src="{{ URL::asset('backend/assets/js/pages/two-step-verification.init.js') }}"></script>
@endsection
